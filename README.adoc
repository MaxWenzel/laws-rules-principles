...
____
The irrational tendency to keep investing in a failing endeavor (like a project, relationship, or even watching a bad movie) because of the time, money, or effort already spent (the "sunk costs"), rather than cutting losses and choosing a better future option.
____

== Lindy effect
____
The Lindy effect (also known as Lindy's law) is a theorized phenomenon by which the future life expectancy of some non-perishable thing, like a technology or an idea, is proportional to its current age. 
____
...
providing data normalization to a canonical form
____

== POLA Principle
____
The principle of least astonishment (POLA), also known as principle of least surprise (POLS), proposes that a component of a system should behave in a way that most users will expect it to behave, and therefore not astonish or surprise users.
____
...
=== Three Laws of Consulting (Gerald Weinberg)
____
